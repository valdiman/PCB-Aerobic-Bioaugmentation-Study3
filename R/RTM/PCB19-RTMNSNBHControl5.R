...

{
  ...
  # Export data
  #write.csv(model_results_daily_clean, file = "Output/Data/RTM/PCB19Control5.csv")
...
# Save plot in folder
ggsave("Output/Plots/RTM/PCB19Control5.png", plot = p.19, width = 6,
       height = 5, dpi = 500)
