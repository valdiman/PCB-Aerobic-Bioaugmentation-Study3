...
rtm.PCB4 = function(t, state, parms){
  ...
  # Add sorption effect on Cpw, Cw and Cf due to biochar and LB400
  Cpw <- Cpw * BCB
  Cw <- Cw * BCB
  #Cf <- Cf * 0.025 / BCB
...

{
  ...
  # Export data
  #write.csv(model_results_daily_clean, file = "Output/Data/RTM/PCB4Treatment.csv")
...
# Save plot in folder
ggsave("Output/Plots/RTM/PCB4Treatment.png", plot = p.4, width = 6,
       height = 5, dpi = 500)
