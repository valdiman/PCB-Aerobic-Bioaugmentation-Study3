...
rtm.PCB31 = function(t, state, parms){
...

{
  ...
  # Export data
  write.csv(model_results_daily_clean, file = "Output/Data/RTM/PCB31Treatment.csv")
...
# Save plot in folder
ggsave("Output/Plots/RTM/PCB31Treatment.png", plot = p.31, width = 6,
       height = 5, dpi = 500)
